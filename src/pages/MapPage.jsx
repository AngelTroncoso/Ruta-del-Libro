...
export default function MapPage() {
  ...
  const routeScenarios = {
    'l7': [ // Hijo de Ladrón
      { id: 1, pos: [-33.4398, -70.6765], type: 'route', title: 'Barrio Yungay (Catedral con Libertad)', desc: 'Esquinas y conventillos reales que recorría Aniceto Hevia al llegar a Santiago Centro.' },
      { id: 2, pos: [-33.4315, -70.6540], type: 'route', title: 'Antigua Estación Mapocho', desc: 'Ribera del río Mapocho y hito ferroviario que conectaba con la periferia del norte.' },
      { id: 3, pos: [-33.4140, -70.6480], type: 'metro', title: 'Cementerio General / Recoleta', desc: 'Camino obligado de los sectores populares hacia el sector norte.' },
      { id: 4, pos: [-33.3850, -70.6280], type: 'route', title: 'Canteras de Huechuraba', desc: 'Las faldas del cerro en el norte de Santiago donde transitaban trabajadores y vagabundos.' }
    ],
    'h10': [ // Martín Rivas
      { id: 1, pos: [-33.4372, -70.6506], type: 'route', title: 'Plaza de Armas de Santiago', desc: 'El epicentro de la sociedad colonial y republicana del siglo XIX.' },
      { id: 2, pos: [-33.4368, -70.6535], type: 'cafe', title: 'Catedral de Santiago y calle Bandera', desc: 'Entorno inmediato de la señorial casa de don Dámaso Encina.' },
      { id: 3, pos: [-33.4380, -70.6410], type: 'route', title: 'Cerro Huelén (Santa Lucía)', desc: 'Escenario de paseos románticos y reflexiones del protagonista Martín Rivas.' }
    ],
    'h11': [ // Palomita blanca
      { id: 1, pos: [-33.4395, -70.6585], type: 'route', title: 'Liceo 1 Javiera Carrera (Santiago Centro)', desc: 'Establecimiento educacional donde asiste María en el centro histórico.' },
      { id: 2, pos: [-33.4245, -70.6120], type: 'cafe', title: 'Av. Providencia y Pedro de Valdivia', desc: 'Intersección de realidades sociales y culturales de la época de los 70.' },
      { id: 3, pos: [-33.3950, -70.6250], type: 'route', title: 'Falda Norte de San Cristóbal (Huechuraba)', desc: 'Límite geográfico norte donde la naturaleza cobijaba la travesía de los jóvenes.' }
    ],
    'h12': [ // Casa grande
      { id: 1, pos: [-33.4495, -70.6655], type: 'route', title: 'Barrio República (Calle Dieciocho)', desc: 'Eje residencial de los fastuosos palacios de la elite chilena de la época.' },
      { id: 2, pos: [-33.4418, -70.6515], type: 'cafe', title: 'Club de la Unión (Alameda)', desc: 'Sede de las intrigas, lujos y alta sociedad relatadas magistralmente por Orrego Luco.' }
    ],
